...
func TestPreviewReturnsTheClassAndTheTeacher(t *testing.T) {
	...
	if got.Outcome != domain.PreviewOK {
...
func TestTheFourRefusalsAreDistinguishable(t *testing.T) {
	...
	t.Run("invalid", func(t *testing.T) {
		...
		if got.Outcome != domain.PreviewInvalid {
	...
	t.Run("revoked", func(t *testing.T) {
		...
		if got.Outcome != domain.PreviewRevoked {
	...
	t.Run("expired", func(t *testing.T) {
		...
		if got.Outcome != domain.PreviewExpired {
	...
	t.Run("exhausted", func(t *testing.T) {
		...
		if got.Outcome != domain.PreviewExhausted {
