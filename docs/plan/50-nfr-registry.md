...
| NFR-M02 | CI runs every check a merge needs: Contract, Web (lint, typecheck, format, unit, integration, build), E2E stubbed, E2E live against a real PG18, Server (vet, staticcheck, golangci-lint, gofmt, unit + integration + end-to-end tests), Sonar | §14 | ✅ | `.github/workflows/ci.yml`, six jobs |
