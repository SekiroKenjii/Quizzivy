...
**Touches:** `migrations/`
**Size:** M
**Migrations:** `00018_create_assignments.sql`,
...
**Touches:** `migrations/`
**Size:** S
**Migrations:** `00020_create_attempts.sql`
**Done when:**
...
**Touches:** `server/internal/attempts/`
**Size:** M
**Migrations:** `00021_create_attempt_answers.sql`
**Done when:**
...
**Touches:** `server/internal/attempts/`
**Size:** S
**Migrations:** `00022_create_attempt_audio_plays.sql`
**Done when:**
...
**Size:** M
**Migrations:** `00023_create_attempt_events.sql`, `00009_grant_app_role.sql`
**Done when:**
