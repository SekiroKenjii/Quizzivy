 ...
 * it: G-01's contextual bar above <main>, and the deck's side panel beside it
 * (G-01, G-07, A-04, S-08). Both are rendered by the screen and portalled into
 * the element the shell provides here, so they sit OUTSIDE the scrolling main
 * and stay put the way the topbar does -- no sticky, no negative margins.
 *
