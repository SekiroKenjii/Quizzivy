  ...
  return (
    <input
      ...
      className={cn(
        ...
        "in-data-[scale=deck]:bg-bg dark:in-data-[scale=deck]:bg-bg in-data-[scale=deck]:lg:text-ui in-data-[scale=deck]:aria-invalid:border-danger in-data-[scale=deck]:h-9.5 in-data-[scale=deck]:px-3 in-data-[scale=deck]:shadow-none in-data-[scale=deck]:focus-visible:ring-0",
        size === "lg" &&
