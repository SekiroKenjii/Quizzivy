...
export interface components {
    schemas: {
        ...
        ImportCapabilities: {
            retention: components["schemas"]["ImportRetention"];
            /**
        ...
        /**
         * @description How long an import keeps its original files and review draft. After
         ...
         */
        ImportRetention: {
            afterCommitDays: number;
            afterCancelDays: number;
            idleDays: number;
        };
        ImportLimits: {
            /** Format: int64 */
...
export interface operations {
    ...
    changePassword: {
        ...
        requestBody: {
            content: {
                "application/json": {
                    ...
                    /**
                     * @description At least 8 characters, at least one of which is a digit, a
        ...
        responses: {
             ...
             *     `PASSWORD_UNCHANGED` — `newPassword` is the password it would replace:
             *     the verified `currentPassword`, or, while `mustChangePassword` is set,
             *     the temporary password on the account.
             *     `VALIDATION_FAILED` — `newPassword` breaks a rule above.
             *
    ...
    downloadImportSource: {
        ...
        responses: {
            ...
            /** @description IMPORT_FILES_REMOVED — retention removed this import's files. */
            410: {
                headers: {
                    [name: string]: unknown;
                };
